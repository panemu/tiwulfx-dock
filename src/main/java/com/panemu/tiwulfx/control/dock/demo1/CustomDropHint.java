...
public class CustomDropHint extends TabDropHint {
	...
	public CustomDropHint() {
		arrow.setContent(
		    "M1.745 14.475l-1.11-1.11c-.47-.47-.47-1.23 0-1.695L10.35 1.95c.47-.47 1.23-.47 1.695 0l9.715 9.715c.47.47 .47 1.23 0 1.695L20.65 14.47c-.475.475-1.25.465-1.715-.02L13.2 8.43V22.8c0 .665-.535 1.2-1.2 1.2h-1.6c-.665 0-1.2-.535-1.2-1.2V8.43L3.46 14.455c-.465.49-1.24.5-1.715.02z");
